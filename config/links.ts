...
export const links: readonly [
  ...
  {
    url: 'https://github.com/devcloudninjas',
    icon: SiGithub,
  ...
  {
    url: 'http://linkedin.com/company/devcloudninjas/',
    icon: SiLinkedin,
    fill: 'fill-[#0A66C2]',
  ...
  {
    url: 'https://telegram.me/devcloudninjas',
    icon: SiTelegram,
    fill: 'fill-[#0088cc]',
  ...
  {
    url: 'https://instagram.com/devcloudninjas',
    icon: SiInstagram,
