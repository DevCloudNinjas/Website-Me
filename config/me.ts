...
export const me = {
  site: 'https://www.devcloudninjas.com',
  name: 'DevCloud Ninjas',
  image: '/static/images/portrait.png',
  email: 'mailto:sensei@devcloudninjas.com',
  location: {
  ...
  social: [
    ...links,
    {
      url: 'mailto:sensei@devcloudninjas.com',
      icon: SiGmail,
      fill: 'fill-[#DB4437]',
  ...
  openSources: [
    {
      ...
      website: 'https://github.com/devcloudninjas/DevOps-Projects',
      link: 'https://github.com/devcloudninjas/DevOps-Projects',
      tags: [
        {
          name: '⭐ 250+',
          color: 'yellow',
    ...
    },
    {
      ...
      website: 'https://github.com/devcloudninjas/into-the-devops',
      link: 'https://github.com/devcloudninjas/into-the-devops',
      tags: [
        {
          name: 'DevOps-Tools',
          color: 'gray',
